...
class ArticleController{
    ...
    public function edit(){
        ...
        $getIdArticle = ArticleService::getByID($ma_bviet);
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            if(isset($_POST['edit'])){
                ArticleService::update($ma_bviet1, $tieude, $ten_bhat, $ma_tloai1, $tomtat, $noidung, $ma_tgia1, $ngayviet, $hinhanh);
    ...
    public function add(){
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            if(isset($_POST['add'])){
                ArticleService::add('', $tieude, $ten_bhat, $ma_tloai, $tomtat, $noidung, $ma_tgia, $ngayviet, $hinhanh);
                echo "<script>window.location.href = 'index.php?controller=article'</script>";
            }
        }
    ...
    public function delete(){
        if($_SERVER['REQUEST_METHOD'] == 'GET'){
            ...
            if($_GET['action'] == 'delete'){
                $getId = ArticleService::getByID($ma_bviet);
